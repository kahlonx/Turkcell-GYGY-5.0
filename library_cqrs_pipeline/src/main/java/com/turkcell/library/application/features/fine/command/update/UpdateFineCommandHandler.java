...
@Component
public class UpdateFineCommandHandler implements RequestHandler<UpdateFineCommand, UpdatedFineResponse> {
    private final FineRepository repository;
    
    public UpdateFineCommandHandler(FineRepository repository) {
        this.repository = repository;
    }

    @Override
    public UpdatedFineResponse handle(UpdateFineCommand request) {
